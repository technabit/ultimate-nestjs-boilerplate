...
export declare class AuthModule implements NestModule, OnModuleInit {
    ...
    private logger;
    constructor(auth: Auth, discoveryService: DiscoveryService, metadataScanner: MetadataScanner, adapter: HttpAdapterHost);
    onModuleInit(): void;
    ...
    static forRootAsync(): {
        ...
        providers: (typeof BetterAuthService | {
            provide: string;
            useFactory: (cacheService: CacheService, configService: ConfigService<GlobalConfig>, authService: AuthService) => Promise<{
            ...
            inject: (typeof CacheService | typeof AuthService | typeof ConfigService)[];
        })[];
        exports: (string | typeof BetterAuthService)[];
    };
}
