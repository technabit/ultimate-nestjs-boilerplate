...
const mail_config_1 = tslib_1.__importDefault(require("./mail.config"));
describe('MailConfig', () => {
    ...
    it('should return the mail configuration', async () => {
        ...
        const config = await (0, mail_config_1.default)();
    ...
    describe('host', () => {
        it('should throw an error if MAIL_HOST is an empty string', async () => {
            ...
            await expect(async () => await (0, mail_config_1.default)()).rejects.toThrow(Error);
        });
...
//# sourceMappingURL=mail-config.spec.js.map