...
const database_config_1 = tslib_1.__importDefault(require("./database.config"));
describe('databaseConfig', () => {
    ...
    describe('host', () => {
        it('should return the value of DATABASE_HOST', async () => {
            ...
            const config = await (0, database_config_1.default)();
        ...
        it('should throw an error when DATABASE_HOST is not set', async () => {
            ...
            await expect(async () => await (0, database_config_1.default)()).rejects.toThrow(Error);
        });
    });
    describe('port', () => {
...
//# sourceMappingURL=database-config.spec.js.map