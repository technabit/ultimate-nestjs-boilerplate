...
export type EmailJob = Job<EmailVerificationJob['data'], any, typeof EmailJob.EmailVerification> | Job<SignInMagicLinkJob['data'], any, typeof EmailJob.SignInMagicLink> | Job<ResetPasswordJob['data'], any, typeof EmailJob.ResetPassword>;
export {};
